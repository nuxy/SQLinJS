...
- Supports jQuery .data() for database storage.
...
Download the latest {sources}[https://github.com/nuxy/SQLinJS/downloads] and refer to the {README}[http://labs.mbrooks.info/demos/SQLinJS/README.html] for more information about this package.
